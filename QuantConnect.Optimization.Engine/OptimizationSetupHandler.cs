...
namespace QuantConnect.Optimization.Engine
{
    ...
    /// </summary>
    public class OptimizationSetupHandler : ISetupHandler
    {
        /// <summary>
        ...
        public Dictionary<string, Tuple<Type, object>> Permutation { get; private set; }

        /// <summary>
        /// Setup the algorithm data, cash, job start end date etc:
        /// </summary>
        public OptimizationSetupHandler()
        {
        ...
        public OptimizationSetupHandler(Dictionary<string, Tuple<Type, object>> permutation)
            :this()
        {
        ...
        public bool Setup(IAlgorithm algorithm, out IBrokerage brokerage, AlgorithmNodePacket baseJob, IResultHandler resultHandler, ITransactionHandler transactionHandler, IRealTimeHandler realTimeHandler)
        {
            ...
            try
            {
                ...
                if (baseJob.Type == PacketType.BacktestNode)
                {
                    ...
                    //Set current optimization permutation
                    QCAlgorithm.AssignParameters(Permutation, algorithm);
